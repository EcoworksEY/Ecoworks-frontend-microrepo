                ...
                <div className='description_container'>
                    ...
                    <div className='quantity_wishlist_container'>
                        <div className='quantity_box'>
                            <img src = {minus} alt = '' style = {{'cursor': 'pointer'}} onClick = {handleDecrease}/>
                            <p className='quantity_text'>QTY: {quantity}</p>
                            <img src = {plus} alt = '' style = {{'cursor': 'pointer'}} onClick = {handleIncrease}/>
                        </div>
                    ...
                    <div className='single_product_general_button'>
                        <p></p>
                        <p className='single_product_general_button_text description'>features</p>
                        <img className = 'arrow_icon' src = {arrow} alt = ''></img>
                    </div>
                    <div className='single_product_general_button'>
                        <p></p>
                        <p className='single_product_general_button_text description'>kindness to planet</p>
                        <img className = 'arrow_icon' src = {arrow} alt = ''></img>
                    </div>
                    ...
                    <div className='buy_now_pay_later_info'>
                        <div className= 'returns_text'>
                            <img className = 'single_return_icon' src = {returnsIcon} alt=''></img>
                            30 days Returns
                        </div>
                        <div className='buy_now_icon'>
                            <img src = {infoIcon} alt=''></img>
